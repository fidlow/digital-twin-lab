...
export const LESSONS: Lesson[] = [
  {
    ...
    steps: [
      ...
      { text: "Возвращаем режим в норму. Охлаждение всё ещё на максимуме — установка быстро остынет. Дождитесь, пока температура опустится в зелёную зону, и нажмите следующий шаг.", action: { kind: "setMode", mode: "normal" }, advanceOn: { kind: "manual" } },
