...
export const SCENARIOS = {
  normal: ["Норма", "Все системы в штатном режиме, отказов нет."],
  thermal: ["Перегрев", "Заклинивший термостат: ток и мощность нагревателя самопроизвольно растут; повреждённая изоляция добавляет внешний теплопоток."],
  vacuum: ["Утечка вакуума", "Негерметичность уплотнения или клапана: воздух подсасывается в камеру, давление растёт со временем."],
  signal: ["Дрейф сигнала", "Потеря заземления или старение датчика: измерительный канал случайно блуждает от базовой линии."],
  power: ["Нестабильность питания", "Пульсации источника или плохой силовой контакт: ток идёт импульсами, вызывая синхронные механические колебания."],
} as const;
